 ...
 * @author edisonarango
 */
@WebServlet(name = "VerificarSudoku", urlPatterns = {"/VerificarSudoku"})
public class VerificarSudoku extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String resultado = sudoku.verificacionSudoku(parametros);
